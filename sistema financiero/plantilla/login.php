                ...
                <div class="col-xl-10 col-lg-12 col-md-9">
                    ...
                    <div class="card o-hidden border-0 shadow-lg my-5">
                        <div class="card-body p-0">
                            ...
                            <div class="row">
                                <div class="col-lg-6 d-none d-lg-block"><img src = "imagenes/imagen de login.jpg" width="500" height="500"></div>
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-4">Bienvenido a tu Asistente Financiero</h1>
                                        </div>
                                        <form role="form" method="POST" action="../Controlador.php" name="formLogin">
                                            ...
                                            <input type="button" class="btn btn-lg btn-success btn-block" onclick="validar_logueo();" value="Ingresar"> Login
                                            </a>
                                            <hr>
                                        </form>
                                        <hr>
                                        ...
                                        <div class="text-center">
                                            <a class="small" href="./register.php">Registrate Aqui!</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
