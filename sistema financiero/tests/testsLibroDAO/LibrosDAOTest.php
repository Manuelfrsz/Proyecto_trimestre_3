...
final class LibrosDAOTest extends TestCase {
    ...
    public function testInsertar($dato = array('isbn' => 1, 'titulo' => 'TPS 2252819', 'autor' => 'Camilo Boada', 'precio' => 100000, 'categoriaLibro_catLibId' => 1)) {
        $realizado = $this->op->insertar($dato);
        $this->assertTrue(($realizado['inserto']));
    }

    public function testActualizar($dato = array(array('titulo' => 'BEBE x 2', 'autor' => 'Levin, Ina Massler', 'precio' => 27300, 'categoriaLibro_catLibId' => 2, 'isbn' => 1548,))) {
